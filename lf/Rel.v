...
Proof.
  ...
  - intros. destruct b.
    + inversion H.
    + f_equal. apply IHa. apply le_S_n. apply H. apply le_S_n. apply H0.
Qed. 
(** [] *)
...
Theorem le_step : forall n m p,
  ...
  n <= p.
Proof.
  intros. apply le_S_n. apply le_trans with m. apply H. apply H0. Qed.
(** [] *)
...
Proof.
  ...
  induction H.
  - apply H0.
  - apply rt1n_trans with y. apply Hxy. apply IHclos_refl_trans_1n. apply H0.
Qed.
(** [] *)
...
Proof.
  ...
  - intros H. induction H.
    + apply rt_refl.
    + apply rt_trans with (y:=y). apply rt_step. apply Hxy. apply IHclos_refl_trans_1n.
Qed.
(** [] *)
